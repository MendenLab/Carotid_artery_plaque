...
ref_genomes=c('GRCh38-p14-Gencode_v44','GRCh38-p13-Gencode_v33')[1:1]
intron_status_list=c('with_intron','without_intron')


for (ref_genome in ref_genomes){
  
  for (intron_status in intron_status_list){
    ...
    fname=paste0('../../data/',ref_genome,'_',intron_status,'_data_QC.h5ad')
    dat=zellkonverter::readH5AD(fname,reader='python')
    print(c(ref_genome,intron_status))
    ...
    fn2=paste0('../../data/',ref_genome,'_',intron_status,'_data_QC_norm.h5ad')
